...
## Checking the structure of everwrk, age_p, r_maritl.
...
##Constructin Logistic Regression model

everwrkage.mod<- glm(everwrk ~ age_p + r_maritl, data = NH11,
       family = "binomial")
coef(summary(everwrkage.mod))
...
everwrk.Martial <- data.frame(allEffects("r_maritl", everwrkage.mod))
plot(everwrk.Martial)
