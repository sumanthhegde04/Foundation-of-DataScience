...
Video Game is an electronic game that is played on electronic medium devices such as personal computer, TV screen, gaming console or mobile phone. Some time the Video Game industry is called the interactive entertainment industry.The problem I am going address here is the analysis on video game sales based on their ratings. I will also try to explore the problem faced by video game industry i.e. which game trends the most highest ratings.

2. Who is your client and why do they care about this problem? In other words, what will your client DO or DECIDE based on your analysis that they wouldn't have otherwise?

vgchartz is the client who would be benefit and  this data set simply extends the number of variables with another web scrape from Metacritic. Unfortunately, there are missing observations as Metacritic only covers a subset of the platforms.The problem is mainly to choose which is the best metacritic game based on the analysis of ratings.
